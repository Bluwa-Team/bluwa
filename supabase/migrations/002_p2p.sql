...
--
-- NB : pas de table suppliers — on utilise public.fournisseurs (existante)
...
CREATE TABLE public.goods_receipt_items (
    ...
    batch_number            TEXT,                         -- lot interne (MP-20260615-0001)
...
-- Achat direct au marché, auprès d'un collecteur local, d'un transporteur, etc.
...
CREATE TABLE public.purchase_receipts (
    ...
    fournisseur_nom   TEXT,                           -- nom libre si non référencé
...
CREATE TABLE public.supplier_payments (
    ...
    CONSTRAINT supplier_payments_source_check CHECK (
...
-- ── STOCK_MOVEMENTS (journal immuable — jamais UPDATE ni DELETE) ──────────────
...
CREATE INDEX idx_purchase_orders_fournisseur    ON public.purchase_orders(fournisseur_id);
...
CREATE INDEX idx_purchase_receipts_fournisseur  ON public.purchase_receipts(fournisseur_id);
