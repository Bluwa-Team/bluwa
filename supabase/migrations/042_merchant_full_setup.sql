...
BEGIN
  ...
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO org_id;
  ...
  VALUES (org_id, 'Chom Factory', 'Sénégal', 'trial', 'Growth', 'john@bluwa.io',
    'Fondatrice : Kossiwa. 5 employés, 5T/mois. Besoins : Production + Analyse de marge. Calls vendredis.')
  ...
  VALUES (org_id, 'Africube', 'Togo', 'trial', 'Growth', 'john@bluwa.io',
    'Dir. : Ayité Ajavon. 23 employés, 11 000 sachets/jour. LOI + NDA via Yousign le 4 juin 2026.')
  ON CONFLICT DO NOTHING;
