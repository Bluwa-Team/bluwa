...
import { GitBranch, Search, FileDown, Package, Box, CornerDownRight, TruckIcon } from 'lucide-react'
...
const EXAMPLES = [
  { label: 'Lot PF', code: 'PF-20250930-0041' },
  { label: 'Lot PF (Vanille)', code: 'PF-20250930-0042' },
  { label: 'Lot MP (Hibiscus)', code: 'MP-20250928-0031' },
  { label: 'Lot AC (Bouteilles)', code: 'AC-20250929-0018' },
]

// ── Page ──────────────────────────────────────────────────────────────────────

export default function GenealogiePage() {
  const [query, setQuery] = useState('PF-20250930-0041')
  const [result, setResult] = useState<SearchResult | null>(() => doSearch('PF-20250930-0041'))
      ...
      <div className="rounded-xl border bg-card p-5 space-y-4">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Ex : PF-20250930-0041 ou MP-20250928-0031"
