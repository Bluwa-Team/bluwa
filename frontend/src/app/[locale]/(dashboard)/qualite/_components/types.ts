...
export const MOCK_GENEALOGIE: GenealogiePF[] = [
  {
    ...
    statut: 'EnControle',
    ingredients: [
      { codeLot: 'MP-20260522-0031', article: "Fleurs d'Hibiscus",        typeArticle: 'MP', qteUtilisee: 6,   unite: 'kg', fournisseur: 'Coopérative de Thiès', dateReception: '2026-05-22', statut: 'EnControle' },
      { codeLot: 'MP-20260510-0028', article: 'Sucre raffiné',            typeArticle: 'MP', qteUtilisee: 9.6, unite: 'kg', fournisseur: 'Sucrivoire SA',         dateReception: '2026-05-10', statut: 'Libere'     },
      { codeLot: 'MP-20260516-0025', article: 'Eau purifiée',             typeArticle: 'MP', qteUtilisee: 240, unite: 'L',  fournisseur: 'Forage interne',         dateReception: '2026-05-24', statut: 'Libere'     },
      { codeLot: 'AC-20260523-0018', article: 'Bouteilles 1L PET',        typeArticle: 'AC', qteUtilisee: 240, unite: 'u',  fournisseur: 'PlastiSénégal',          dateReception: '2026-05-23', statut: 'EnControle' },
      { codeLot: 'AC-20260515-0016', article: 'Bouchons vissants',        typeArticle: 'AC', qteUtilisee: 240, unite: 'u',  fournisseur: 'PlastiSénégal',          dateReception: '2026-05-15', statut: 'Libere'     },
      { codeLot: 'AC-20260518-0017', article: 'Etiquettes autocollantes', typeArticle: 'AC', qteUtilisee: 240, unite: 'u',  fournisseur: 'ImpriPrint Dakar',       dateReception: '2026-05-18', statut: 'Libere'     },
    ],
    destinations: [
  ...
  },
  {
    ...
    statut: 'Libere',
    ingredients: [
      { codeLot: 'MP-20260522-0031', article: "Fleurs d'Hibiscus", typeArticle: 'MP', qteUtilisee: 3,   unite: 'kg', fournisseur: 'Coopérative de Thiès', dateReception: '2026-05-22', statut: 'EnControle' },
      { codeLot: 'MP-20260522-0032', article: 'Sucre raffiné',     typeArticle: 'MP', qteUtilisee: 4.8, unite: 'kg', fournisseur: 'Sucrivoire SA',         dateReception: '2026-05-22', statut: 'EnControle' },
      { codeLot: 'MP-20260516-0025', article: 'Eau purifiée',      typeArticle: 'MP', qteUtilisee: 120, unite: 'L',  fournisseur: 'Forage interne',         dateReception: '2026-05-23', statut: 'Libere'     },
      { codeLot: 'AC-20260523-0018', article: 'Bouteilles 1L PET', typeArticle: 'AC', qteUtilisee: 120, unite: 'u',  fournisseur: 'PlastiSénégal',          dateReception: '2026-05-23', statut: 'EnControle' },
      { codeLot: 'AC-20260515-0016', article: 'Bouchons vissants', typeArticle: 'AC', qteUtilisee: 120, unite: 'u',  fournisseur: 'PlastiSénégal',          dateReception: '2026-05-15', statut: 'Libere'     },
    ],
    destinations: [
