    ...
    <section className="rounded-xl border bg-card p-5 space-y-4">
      ...
      {!subscription ? (
        <p className="text-sm text-muted-foreground">
          ...
          <a href="mailto:support@bluwa.io" className="underline underline-offset-2 hover:text-foreground transition-colors">
            Contacter Bluwa
          </a>
        </p>
      ) : (
          ...
          {subscription.status === 'PAST_DUE' && (
            <div className="flex items-start gap-2.5 rounded-lg border border-amber-200 dark:border-amber-700 bg-amber-50 dark:bg-amber-950/30 px-3.5 py-3">
              ...
              <p className="text-sm text-amber-700 dark:text-amber-300">
                ...
                <a href="mailto:support@bluwa.io" className="underline underline-offset-2 font-medium">
                  Contacter Bluwa
                </a>{' '}
