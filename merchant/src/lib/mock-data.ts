...
export const MOCK_INSTALLATION_FEES: InstallationFee[] = [
  // XOF
  { id: 'if-1',  factory_id: 'fac-1',  size: 'pme',    amount_xof: 500000,  currency: 'XOF', amount_local: 500000,                             status: 'paid',    paid_at: '2026-01-14T00:00:00Z', notes: null,                               created_at: '2026-01-10T00:00:00Z' },
  { id: 'if-2',  factory_id: 'fac-2',  size: 'tpe',    amount_xof: 150000,  currency: 'XOF', amount_local: 150000,                             status: 'paid',    paid_at: '2026-01-30T00:00:00Z', notes: null,                               created_at: '2026-01-28T00:00:00Z' },
  { id: 'if-3',  factory_id: 'fac-3',  size: 'tpe',    amount_xof: 150000,  currency: 'XOF', amount_local: 150000,                             status: 'pending', paid_at: null,                   notes: 'Acompte 75k reçu',                 created_at: '2026-03-28T00:00:00Z' },
  { id: 'if-4',  factory_id: 'fac-4',  size: 'grande', amount_xof: 1500000, currency: 'XOF', amount_local: 1500000,                            status: 'paid',    paid_at: '2026-02-08T00:00:00Z', notes: null,                               created_at: '2026-02-01T00:00:00Z' },
  { id: 'if-5',  factory_id: 'fac-5',  size: 'pme',    amount_xof: 500000,  currency: 'XOF', amount_local: 500000,                             status: 'paid',    paid_at: '2026-02-28T00:00:00Z', notes: null,                               created_at: '2026-02-25T00:00:00Z' },
  { id: 'if-6',  factory_id: 'fac-6',  size: 'tpe',    amount_xof: 150000,  currency: 'XOF', amount_local: 150000,                             status: 'partial', paid_at: null,                   notes: 'Acompte 75k payé',                 created_at: '2026-03-28T00:00:00Z' },
  // Ghana — GHS
  { id: 'if-7',  factory_id: 'fac-9',  size: 'grande', amount_xof: 1500000, currency: 'GHS', amount_local: localInstall('grande', 'GHS'),      status: 'paid',    paid_at: '2026-03-05T00:00:00Z', notes: null,                               created_at: '2026-03-01T00:00:00Z' },
  { id: 'if-8',  factory_id: 'fac-10', size: 'pme',    amount_xof: 500000,  currency: 'GHS', amount_local: localInstall('pme', 'GHS'),         status: 'paid',    paid_at: '2026-03-20T00:00:00Z', notes: null,                               created_at: '2026-03-15T00:00:00Z' },
  // Nigeria — NGN
  { id: 'if-9',  factory_id: 'fac-11', size: 'grande', amount_xof: 1500000, currency: 'NGN', amount_local: localInstall('grande', 'NGN'),      status: 'paid',    paid_at: '2026-04-02T00:00:00Z', notes: null,                               created_at: '2026-03-28T00:00:00Z' },
  { id: 'if-10', factory_id: 'fac-12', size: 'grande', amount_xof: 1500000, currency: 'NGN', amount_local: localInstall('grande', 'NGN'),      status: 'paid',    paid_at: '2026-04-10T00:00:00Z', notes: null,                               created_at: '2026-04-05T00:00:00Z' },
  { id: 'if-11', factory_id: 'fac-13', size: 'pme',    amount_xof: 500000,  currency: 'NGN', amount_local: localInstall('pme', 'NGN'),         status: 'pending', paid_at: null,                   notes: 'Wire transfer pending — Lagos bank', created_at: '2026-05-01T00:00:00Z' },
  // Niger — XOF
  { id: 'if-12', factory_id: 'fac-14', size: 'pme',    amount_xof: 500000,  currency: 'XOF', amount_local: 500000,                             status: 'paid',    paid_at: '2026-03-20T00:00:00Z', notes: null,                               created_at: '2026-03-15T00:00:00Z' },
  // Togo — XOF
  { id: 'if-13', factory_id: 'fac-15', size: 'pme',    amount_xof: 500000,  currency: 'XOF', amount_local: 500000,                             status: 'paid',    paid_at: '2026-02-28T00:00:00Z', notes: null,                               created_at: '2026-02-20T00:00:00Z' },
  { id: 'if-14', factory_id: 'fac-16', size: 'tpe',    amount_xof: 150000,  currency: 'XOF', amount_local: 150000,                             status: 'paid',    paid_at: '2026-03-12T00:00:00Z', notes: null,                               created_at: '2026-03-05T00:00:00Z' },
  // Bénin — XOF
  { id: 'if-15', factory_id: 'fac-17', size: 'tpe',    amount_xof: 150000,  currency: 'XOF', amount_local: 150000,                             status: 'pending', paid_at: null,                   notes: null,                               created_at: '2026-04-10T00:00:00Z' },
  // Guinée — GNF
  { id: 'if-16', factory_id: 'fac-18', size: 'pme',    amount_xof: 500000,  currency: 'GNF', amount_local: localInstall('pme', 'GNF'),         status: 'paid',    paid_at: '2026-04-05T00:00:00Z', notes: null,                               created_at: '2026-03-25T00:00:00Z' },
  // Sierra Leone — SLE
  { id: 'if-17', factory_id: 'fac-19', size: 'tpe',    amount_xof: 150000,  currency: 'SLE', amount_local: localInstall('tpe', 'SLE'),         status: 'partial', paid_at: null,                   notes: 'Acompte 50% reçu',                 created_at: '2026-04-18T00:00:00Z' },
  // Liberia — LRD
  { id: 'if-18', factory_id: 'fac-20', size: 'tpe',    amount_xof: 150000,  currency: 'LRD', amount_local: localInstall('tpe', 'LRD'),         status: 'pending', paid_at: null,                   notes: null,                               created_at: '2026-05-01T00:00:00Z' },
  // Gambie — GMD
  { id: 'if-19', factory_id: 'fac-21', size: 'tpe',    amount_xof: 150000,  currency: 'GMD', amount_local: localInstall('tpe', 'GMD'),         status: 'paid',    paid_at: '2026-05-05T00:00:00Z', notes: null,                               created_at: '2026-04-28T00:00:00Z' },
  // Mauritanie — MRU
  { id: 'if-20', factory_id: 'fac-22', size: 'pme',    amount_xof: 500000,  currency: 'MRU', amount_local: localInstall('pme', 'MRU'),         status: 'paid',    paid_at: '2026-04-05T00:00:00Z', notes: null,                               created_at: '2026-03-28T00:00:00Z' },
]
...
export const MOCK_INVOICES: Invoice[] = [
  // Groupe SOKA (XOF)
  { id: 'inv-1',  factory_id: 'fac-1',  subscription_id: 'sub-1',  amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'paid',    due_at: '2026-02-01T00:00:00Z', paid_at: '2026-01-28T00:00:00Z', notes: null, created_at: '2026-01-15T00:00:00Z' },
  { id: 'inv-2',  factory_id: 'fac-1',  subscription_id: 'sub-1',  amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'paid',    due_at: '2026-03-01T00:00:00Z', paid_at: '2026-02-26T00:00:00Z', notes: null, created_at: '2026-02-15T00:00:00Z' },
  { id: 'inv-3',  factory_id: 'fac-1',  subscription_id: 'sub-1',  amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'overdue', due_at: '2026-04-01T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-03-15T00:00:00Z' },
  { id: 'inv-4',  factory_id: 'fac-2',  subscription_id: 'sub-2',  amount_xof: 49000,  currency: 'XOF', amount_local: 49000,                       status: 'paid',    due_at: '2026-03-01T00:00:00Z', paid_at: '2026-02-27T00:00:00Z', notes: null, created_at: '2026-02-01T00:00:00Z' },
  { id: 'inv-5',  factory_id: 'fac-2',  subscription_id: 'sub-2',  amount_xof: 49000,  currency: 'XOF', amount_local: 49000,                       status: 'paid',    due_at: '2026-04-01T00:00:00Z', paid_at: '2026-03-29T00:00:00Z', notes: null, created_at: '2026-03-01T00:00:00Z' },
  // Minoterie du Sahel (XOF)
  { id: 'inv-6',  factory_id: 'fac-4',  subscription_id: 'sub-4',  amount_xof: 399000, currency: 'XOF', amount_local: 399000,                      status: 'paid',    due_at: '2026-03-10T00:00:00Z', paid_at: '2026-03-08T00:00:00Z', notes: null, created_at: '2026-02-10T00:00:00Z' },
  { id: 'inv-7',  factory_id: 'fac-4',  subscription_id: 'sub-4',  amount_xof: 399000, currency: 'XOF', amount_local: 399000,                      status: 'paid',    due_at: '2026-04-10T00:00:00Z', paid_at: '2026-04-09T00:00:00Z', notes: null, created_at: '2026-03-10T00:00:00Z' },
  { id: 'inv-8',  factory_id: 'fac-4',  subscription_id: 'sub-4',  amount_xof: 399000, currency: 'XOF', amount_local: 399000,                      status: 'pending', due_at: '2026-05-10T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-04-10T00:00:00Z' },
  { id: 'inv-9',  factory_id: 'fac-5',  subscription_id: 'sub-5',  amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'paid',    due_at: '2026-04-01T00:00:00Z', paid_at: '2026-03-30T00:00:00Z', notes: null, created_at: '2026-03-01T00:00:00Z' },
  // Agro CI (XOF)
  { id: 'inv-10', factory_id: 'fac-3',  subscription_id: 'sub-3',  amount_xof: 49000,  currency: 'XOF', amount_local: 49000,                       status: 'pending', due_at: '2026-05-01T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-04-01T00:00:00Z' },
  // GoldCoast Foods (GHS)
  { id: 'inv-11', factory_id: 'fac-9',  subscription_id: 'sub-9',  amount_xof: 399000, currency: 'GHS', amount_local: localPlan(2, 'GHS'),         status: 'paid',    due_at: '2026-04-10T00:00:00Z', paid_at: '2026-04-08T00:00:00Z', notes: null, created_at: '2026-03-10T00:00:00Z' },
  { id: 'inv-12', factory_id: 'fac-9',  subscription_id: 'sub-9',  amount_xof: 399000, currency: 'GHS', amount_local: localPlan(2, 'GHS'),         status: 'paid',    due_at: '2026-05-10T00:00:00Z', paid_at: '2026-05-09T00:00:00Z', notes: null, created_at: '2026-04-10T00:00:00Z' },
  { id: 'inv-13', factory_id: 'fac-9',  subscription_id: 'sub-9',  amount_xof: 399000, currency: 'GHS', amount_local: localPlan(2, 'GHS'),         status: 'pending', due_at: '2026-06-10T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-05-10T00:00:00Z' },
  { id: 'inv-14', factory_id: 'fac-10', subscription_id: 'sub-10', amount_xof: 149000, currency: 'GHS', amount_local: localPlan(1, 'GHS'),         status: 'paid',    due_at: '2026-04-20T00:00:00Z', paid_at: '2026-04-18T00:00:00Z', notes: null, created_at: '2026-03-20T00:00:00Z' },
  { id: 'inv-15', factory_id: 'fac-10', subscription_id: 'sub-10', amount_xof: 149000, currency: 'GHS', amount_local: localPlan(1, 'GHS'),         status: 'paid',    due_at: '2026-05-20T00:00:00Z', paid_at: '2026-05-19T00:00:00Z', notes: null, created_at: '2026-04-20T00:00:00Z' },
  // Sunrise Agro (NGN)
  { id: 'inv-16', factory_id: 'fac-11', subscription_id: 'sub-11', amount_xof: 399000, currency: 'NGN', amount_local: localPlan(2, 'NGN'),         status: 'paid',    due_at: '2026-05-05T00:00:00Z', paid_at: '2026-05-03T00:00:00Z', notes: null, created_at: '2026-04-05T00:00:00Z' },
  { id: 'inv-17', factory_id: 'fac-11', subscription_id: 'sub-11', amount_xof: 399000, currency: 'NGN', amount_local: localPlan(2, 'NGN'),         status: 'pending', due_at: '2026-06-05T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-05-05T00:00:00Z' },
  { id: 'inv-18', factory_id: 'fac-12', subscription_id: 'sub-12', amount_xof: 399000, currency: 'NGN', amount_local: localPlan(2, 'NGN'),         status: 'paid',    due_at: '2026-05-12T00:00:00Z', paid_at: '2026-05-10T00:00:00Z', notes: null, created_at: '2026-04-12T00:00:00Z' },
  { id: 'inv-19', factory_id: 'fac-13', subscription_id: 'sub-13', amount_xof: 149000, currency: 'NGN', amount_local: localPlan(1, 'NGN'),         status: 'overdue', due_at: '2026-05-02T00:00:00Z', paid_at: null,                   notes: 'Wire transfer pending — Lagos bank', created_at: '2026-05-02T00:00:00Z' },
  // Sahel Agro Niger (XOF)
  { id: 'inv-20', factory_id: 'fac-14', subscription_id: 'sub-14', amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'paid',    due_at: '2026-04-15T00:00:00Z', paid_at: '2026-04-14T00:00:00Z', notes: null, created_at: '2026-03-15T00:00:00Z' },
  { id: 'inv-21', factory_id: 'fac-14', subscription_id: 'sub-14', amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'paid',    due_at: '2026-05-15T00:00:00Z', paid_at: '2026-05-13T00:00:00Z', notes: null, created_at: '2026-04-15T00:00:00Z' },
  // Togo Alimentation (XOF)
  { id: 'inv-22', factory_id: 'fac-15', subscription_id: 'sub-15', amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'paid',    due_at: '2026-03-20T00:00:00Z', paid_at: '2026-03-18T00:00:00Z', notes: null, created_at: '2026-02-20T00:00:00Z' },
  { id: 'inv-23', factory_id: 'fac-15', subscription_id: 'sub-15', amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'paid',    due_at: '2026-04-20T00:00:00Z', paid_at: '2026-04-19T00:00:00Z', notes: null, created_at: '2026-03-20T00:00:00Z' },
  { id: 'inv-24', factory_id: 'fac-15', subscription_id: 'sub-15', amount_xof: 149000, currency: 'XOF', amount_local: 149000,                      status: 'pending', due_at: '2026-05-20T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-04-20T00:00:00Z' },
  { id: 'inv-25', factory_id: 'fac-16', subscription_id: 'sub-16', amount_xof: 49000,  currency: 'XOF', amount_local: 49000,                       status: 'paid',    due_at: '2026-04-05T00:00:00Z', paid_at: '2026-04-04T00:00:00Z', notes: null, created_at: '2026-03-05T00:00:00Z' },
  // Conakry Agro (GNF)
  { id: 'inv-26', factory_id: 'fac-18', subscription_id: 'sub-18', amount_xof: 149000, currency: 'GNF', amount_local: localPlan(1, 'GNF'),         status: 'paid',    due_at: '2026-04-25T00:00:00Z', paid_at: '2026-04-23T00:00:00Z', notes: null, created_at: '2026-03-25T00:00:00Z' },
  { id: 'inv-27', factory_id: 'fac-18', subscription_id: 'sub-18', amount_xof: 149000, currency: 'GNF', amount_local: localPlan(1, 'GNF'),         status: 'pending', due_at: '2026-05-25T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-04-25T00:00:00Z' },
  // Sierra Food Co. (SLE)
  { id: 'inv-28', factory_id: 'fac-19', subscription_id: 'sub-19', amount_xof: 49000,  currency: 'SLE', amount_local: localPlan(0, 'SLE'),         status: 'paid',    due_at: '2026-05-18T00:00:00Z', paid_at: '2026-05-17T00:00:00Z', notes: null, created_at: '2026-04-18T00:00:00Z' },
  // Gambia Processors (GMD)
  { id: 'inv-29', factory_id: 'fac-21', subscription_id: 'sub-21', amount_xof: 49000,  currency: 'GMD', amount_local: localPlan(0, 'GMD'),         status: 'paid',    due_at: '2026-05-28T00:00:00Z', paid_at: '2026-05-27T00:00:00Z', notes: null, created_at: '2026-04-28T00:00:00Z' },
  // Nouakchott Lait (MRU)
  { id: 'inv-30', factory_id: 'fac-22', subscription_id: 'sub-22', amount_xof: 149000, currency: 'MRU', amount_local: localPlan(1, 'MRU'),         status: 'paid',    due_at: '2026-04-28T00:00:00Z', paid_at: '2026-04-26T00:00:00Z', notes: null, created_at: '2026-03-28T00:00:00Z' },
  { id: 'inv-31', factory_id: 'fac-22', subscription_id: 'sub-22', amount_xof: 149000, currency: 'MRU', amount_local: localPlan(1, 'MRU'),         status: 'pending', due_at: '2026-05-28T00:00:00Z', paid_at: null,                   notes: null, created_at: '2026-04-28T00:00:00Z' },
]
