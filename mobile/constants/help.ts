// Contenu aide contextuelle — un entrée par écran/flux

export type HelpKey =
  | "reception_liste"
  | "reception_bc"
  | "reception_ba_planifie"
  | "reception_ba_direct"
  | "qualite_liste"
  | "qualite_controle"
  | "qualite_nc"
...
export interface HelpContent {
  ...
  etapes:   string[];
  tips?:    string[];
  videoUrl?: string; // YouTube non-listé ou Cloudflare Stream — à remplir quand les vidéos sont tournées
}
...
export const HELP: Record<HelpKey, HelpContent> = {
  ...
  reception_liste: {
    ...
    resume: "Cet écran liste toutes les livraisons et collectes réalisées. Tu peux filtrer par flux (BC / BA) et par statut, ou lancer une nouvelle réception.",
    etapes: [
  ...
  reception_bc: {
    ...
    resume: "Tu réceptionnes une livraison liée à une commande fournisseur existante. Ce flux génère une facture fournisseur dans l'ERP.",
    etapes: [
  ...
  reception_ba_planifie: {
    ...
    resume: "Le Bon d'Achat a été créé en avance par le bureau. Pas de facture — le paiement est direct (mobile money ou espèces).",
    etapes: [
  ...
  reception_ba_direct: {
    ...
    resume: "Un producteur se présente sans rendez-vous. Tu crées le Bon d'Achat sur le moment au prix du jour.",
    etapes: [
  ...
  qualite_liste: {
    ...
    resume: "Liste des lots en attente d'analyse. Chaque réception crée automatiquement un lot 'En attente'. Tu dois analyser et décider : Libérer ou Bloquer.",
    etapes: [
  ...
  qualite_controle: {
    ...
    resume: "Saisis les résultats de tes mesures physiques et chimiques. L'app t'alerte si une valeur dépasse le seuil acceptable.",
    etapes: [
  ...
  qualite_nc: {
    ...
    resume: "Une NC documente officiellement un problème qualité. Elle sert de base pour le litige fournisseur et le suivi des actions correctives.",
    etapes: [
  ...
  of_liste: {
    ...
    resume: "Liste des ordres de fabrication planifiés et en cours. Chaque OF correspond à une production à réaliser avec une quantité cible et une recette définie.",
    etapes: [
  ...
  of_picking: {
    ...
    resume: "Avant de démarrer la production, tu dois prélever physiquement les matières premières et les consommables dans le stock.",
    etapes: [
  ...
  of_mes: {
    ...
    resume: "Le MES (Manufacturing Execution System) te permet de suivre la production en temps réel : déclarations de production, arrêts, rebuts et clôture CCP.",
    etapes: [
  ...
  of_ccp: {
    ...
    resume: "Les CCP (Critical Control Points) sont des mesures obligatoires HACCP à enregistrer en fin de production pour libérer le lot fini.",
    etapes: [
  ...
  inventaire: {
    ...
    resume: "L'inventaire compare le stock théorique (ce que dit le système) avec le stock physique réel. Les écarts sont enregistrés et remontent au responsable.",
    etapes: [
  ...
  ventes_liste: {
    ...
    resume: "Liste des commandes clients avec leur statut. Suit le cycle DRAFT → Confirmée → En préparation → Expédiée → Facturée.",
    etapes: [
  ...
  ventes_new: {
    ...
    resume: "Saisis une commande client directement sur le terrain lors d'une visite. Elle est créée en DRAFT et doit être confirmée par le bureau.",
    etapes: [
